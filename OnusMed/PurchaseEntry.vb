            ...
            Do
                ...
                If (inv.Tables(0).Rows.Count = 0) Then
                    ...
                    ElseIf (chkInterState.Checked = True) Then
                        ...
                        pr_strip_tmp = Math.Round(pr_strip_tmp, 2)
                        pr_piece_tmp = Math.Round(pr_piece_tmp, 2)
                        inventory = String.Concat(New String() {"insert into inventory values('", DataGridView1.Rows(i).Cells(2).Value.ToString(), "','", DataGridView1.Rows(i).Cells(0).Value.ToString(), "','", DataGridView1.Rows(i).Cells(6).Value.ToString(), "',", DataGridView1.Rows(i).Cells(13).Value.ToString(), ",", DataGridView1.Rows(i).Cells(14).Value.ToString(), ",", DataGridView1.Rows(i).Cells(15).Value.ToString(), ",0,0,0,", pr_pack_tmp.ToString(), ",", pr_strip_tmp.ToString(), ",", pr_piece_tmp.ToString(), ",", DataGridView1.Rows(i).Cells(20).Value.ToString(), ",", DataGridView1.Rows(i).Cells(21).Value.ToString(), ",", DataGridView1.Rows(i).Cells(22).Value.ToString(), ",", stock_pack.ToString(), ",", stock_strip.ToString(), ",", stock_piece.ToString(), ",'GD', false,", DataGridView1.Rows(i).Cells(23).Value.ToString(), ");commit;"})
                    End If
